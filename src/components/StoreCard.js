        ...
        <ListGroup>
          <ListGroup.Item>
            ...
            <Button
              ...
              variant='success'
              className='float-end'
              onClick={e => handlePurchase(item_1, item_1_cost)}
            >
              {<MdShoppingBag />}
            </Button>
          </ListGroup.Item>
          <ListGroup.Item>
            ...
            <Button
              ...
              variant='success'
              className='float-end'
              onClick={e => handlePurchase(item_2, item_2_cost)}
            >
              {<MdShoppingBag />}
            </Button>
          </ListGroup.Item>
          <ListGroup.Item>
            ...
            <Button
              ...
              variant='success'
              className='float-end'
              onClick={e => handlePurchase(item_3, item_3_cost)}
            >
              {<MdShoppingBag />}
            </Button>
          </ListGroup.Item>
          <ListGroup.Item>
            ...
            <Button
              ...
              variant='success'
              className='float-end'
              onClick={e => handlePurchase(item_4, item_4_cost)}
            >
              {<MdShoppingBag />}
            </Button>
          </ListGroup.Item>
